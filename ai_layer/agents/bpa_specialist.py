"""
BPAAgent — Phase 3 stub.

Handles matching adjustment eligibility, fundamental spread computation, and MA benefit
for BPA (Bulk Purchase Annuity) runs.
...
class BPAAgent(BaseAgent):
    ...
    def system_prompt(self) -> str:
        raise NotImplementedError("BPAAgent is not implemented until Phase 3 Step 23.")
    ...
    def chat(self, messages: list[dict[str, Any]]) -> Any:
        raise NotImplementedError(
            "BPAAgent is a Phase 3 component.  "
